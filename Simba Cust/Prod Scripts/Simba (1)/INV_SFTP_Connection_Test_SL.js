...
var HTTPSMODULE, SFTPMODULE, SERVERWIDGETMODULE, EMAIL;
 ...
 *@NModuleScope Public
 */
define(["N/https", "N/sftp", "N/ui/serverWidget", "N/email"], runSuitelet);
 
//********************** MAIN FUNCTION **********************
function runSuitelet(https, sftp, serverwidget, email){
    HTTPSMODULE= https;
...
function addPasswordGUID1Fields(form){
    ...
    form.addField({
        ...
        type : SERVERWIDGETMODULE.FieldType.TEXT,
        label : 'Restrict To Remote Domains',
    }).isMandatory = true;
