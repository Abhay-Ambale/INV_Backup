...
//Payment Method
var PAYMENT_METHOD_CASH = 1;

//Account
var ACC_1045_HSBC_Bank_Trust_203 = 554;
var ACC_1020_HSBC_Bank_Trust_202 = 455;
var ACC_4060_DISCOUNTS = 271;
var ACC_2320_GST_COLLECTED = 111;
var ACC_2630_ACCRUED_REBATES = 572;
...
var ORDER_CAT_INTERCOMPANY	= 4;

// Order Category
var POCAT_TREADING		= 1;
var POCAT_NON_TREADING	= 2;
var POCAT_OUTSOURCED	= 3;
var POCAT_INTERCOMP		= 4;
...
var FRM_PO_1SG_PROCU    = 187;
var FRM_INV_CASE_INVOICE_DIS = 134;
...
var EMAIL_NOTIFICATION_ID	= 15575;  // Employee : Simba Notifications

// Taxcode
var TAXCODE_SINGAPORE	= '13775';

var ROLE_UPLOAD_FILE 	= [3, 1167];
...
//Added by Prajval on 21 Mar 19
//used to calculate total days skipping saturdays and sundays
function CalcDate(tDate,nDays)
{   nlapiLogExecution('DEBUG','csvimport','inside CalcDate() function->>');
	var count	    =  0;
	var	endDate	    = "";
	var	shipDate    = "";
	var	finalDate	= "";
	...
	while(count < nDays)
	{
		endDate  = new Date(tDate.setDate(tDate.getDate() + 1));
		if(endDate.getDay() != 0 && endDate.getDay() != 6){
			count++;
		}
	}
	shipDate   	= nlapiDateToString(endDate);
